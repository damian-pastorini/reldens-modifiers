...
class Modifier
{
    ...
    constructor(props)
    {
        ...
        this.minProperty = sc.hasOwn(props, 'minProperty') ? this.parseValue(props.minProperty) : false;
        this.maxProperty = sc.hasOwn(props, 'maxProperty') ? this.parseValue(props.maxProperty) : false;
