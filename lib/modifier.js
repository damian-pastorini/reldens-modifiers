...
class Modifier
{
    ...
    constructor(props)
    {
        ...
        this.key = props.key;
        this.propertyKey = sc.getDef(props, 'propertyKey', props.property_key);
        this.basePropertyKey = sc.getDef(props, 'basePropertyKey', this.propertyKey);
        this.operation = props.operation;
        this.type = sc.getDef(props, 'type', ModifierConst.TYPES.INT);
        ...
        this.conditions = sc.getDef(props, 'conditions', []);
        this.conditionsOnRevert = sc.getDef(props, 'conditionsOnRevert', false);
        this.state = false;
