...
class Modifier
{
    ...
    getModifiedValue(revert = false)
    {
        ...
        let propertyValue = this.getPropertyValue(this.propertyKey);
    ...
    {
        return this.manageOwnerProperty(propName);
    }

    setOwnerProperty(propName, value)
    {
        return this.manageOwnerProperty(propName, value);
    }

    manageOwnerProperty(propName, value)
    {
